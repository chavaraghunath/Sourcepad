...
// extern const LexerModule lmObjC;        // npp custom lexer, not in upstream Xcode project
// extern const LexerModule lmSearchResult; // npp custom lexer, not in upstream Xcode project
// extern const LexerModule lmUserDefine;   // npp custom lexer, not in upstream Xcode project
...
//--Autogenerated -- end of automatically generated section
		// &lmObjC,         // npp custom lexer, see comment above
		// &lmSearchResult, // npp custom lexer, see comment above
		// &lmUserDefine,   // npp custom lexer, see comment above
