...
# then emit a Swift literal table to Sourcepad/Languages/LexerRegistry.swift.
#
# Inputs:
...
#
# Output:
#   - Sourcepad/Languages/LexerRegistry.swift                          (committed)
#
...
OUT_SWIFT       = ROOT / "Sourcepad" / "Languages"  / "LexerRegistry.swift"
OUT_KEYWORDS_H  = ROOT / "Sourcepad" / "Bridge"     / "KeywordSetsGenerated.h"
OUT_KEYWORDS_M  = ROOT / "Sourcepad" / "Bridge"     / "KeywordSetsGenerated.m"
...
CACHE_DIR = Path("/tmp/sourcepad-npp-cache")
...
def emit_swift(ext_map, name_map):
    ...
    lines.append("// Sourcepad — file-extension to Lexilla-lexer mapping.")
